...
- Product wner for cloud CICD pipeline governance
- Started the security engineering training program for the CISO organization
- Cloud Technology Strategy: Hands-on development and architecture of security guardrails infrastructure in our AWS environment
...
- Evaluation and selection of Policy-as-Code and governance tooling for public cloud deployment pipelines
...
- Automated 1st-time setup for a p2v migration of 10k users from desktops to VDI in < 6 months using custom automation I wrote
- Optimized the virtual farms to increase capacity by 12% across 4 datacenters (increased capacity by 8k+ VMs)
- Key experience owner for VM Provisioning overhaul and redesign
...
# Innovation & Patents
I've got 10 issued US Patents and more than 100 pending (non-provisional) --
## Sole inventor:
- [Systems and Methods for Software Development Using Sandbox Views - No. 10,872,032](http://patft.uspto.gov/netacgi/nph-Parser?Sect1=PTO1&Sect2=HITOFF&d=PALL&p=1&u=%2Fnetahtml%2FPTO%2Fsrchnum.htm&r=1&f=G&l=50&s1=10872032.PN.&OS=PN/10872032&RS=PN/10872032). Issued December 22, 2020.
- [Systems and methods for locally streaming applications in a computing system - No. 10,824,534](http://patft.uspto.gov/netacgi/nph-Parser?Sect1=PTO1&Sect2=HITOFF&d=PALL&p=1&u=%2Fnetahtml%2FPTO%2Fsrchnum.htm&r=1&f=G&l=50&s1=10824534.PN.&OS=PN/10824534&RS=PN/10824534). Issued 
...
## Co-Inventor Patents:
- [Independent Notification System for Authentication - No. 10,986,226](http://patft.uspto.gov/netacgi/nph-Parser?Sect1=PTO1&Sect2=HITOFF&d=PALL&p=1&u=%2Fnetahtml%2FPTO%2Fsrchnum.htm&r=1&f=G&l=50&s1=10986226.PN.&OS=PN/10986226&RS=PN/10986226). Issued April 20, 2021.
- [Systems and Methods for Online Identity Management - No. 10,977,335](http://patft.uspto.gov/netacgi/nph-Parser?TERM1=10977335&Sect1=PTO1&Sect2=HITOFF&d=PALL&p=1&u=%2Fnetahtml%2FPTO%2Fsrchnum.htm&r=0&f=S&l=50). Issued April 13, 2021.
- [Climate Control System - No. 10,893,634](http://patft.uspto.gov/netacgi/nph-Parser?Sect1=PTO1&Sect2=HITOFF&d=PALL&p=1&u=%2Fnetahtml%2FPTO%2Fsrchnum.htm&r=1&f=G&l=50&s1=10893634.PN.&OS=PN/10893634&RS=PN/10893634). Issued January 12, 2021.
...
- [Cooling System for Rack-Mounted Electronic Components - No. 10,869,409](http://patft.uspto.gov/netacgi/nph-Parser?TERM1=10869409&Sect1=PTO1&Sect2=HITOFF&d=PALL&p=1&u=%2Fnetahtml%2FPTO%2Fsrchnum.htm&r=0&f=S&l=50). 
## Pending: 
